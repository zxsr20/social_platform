...
namespace DAL
{
    ...
    /// 一对多中的一
    /// </summary>
    public class YiDuiDuoZhongDeYiRepository : BaseRepository,IDisposable 
    {
        /// <summary>
        /// 获取所有一对多中的一
        /// </summary>
        /// <returns>一对多中的一集合</returns>
        public IQueryable<YiDuiDuoZhongDeYi> GetAll()
        {
        ...
        /// </summary>
        /// <returns>一对多中的一集合</returns>
        public IQueryable<YiDuiDuoZhongDeYi> GetAll(SysEntities db)
        {
            return db.YiDuiDuoZhongDeYi.AsQueryable();
        }
        /// <summary>
        /// 导出Flexigrid中查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<YiDuiDuoZhongDeYi> DaoChuData(SysEntities db, FlexigridParam param, params object[] listQuery)
        {
        ...
        /// <summary>
        /// 通过主键id，获取一对多中的一---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>一对多中的一</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>一对多中的一</returns>
        public YiDuiDuoZhongDeYi GetById(SysEntities db, int id)
        { 
            return db.YiDuiDuoZhongDeYi.SingleOrDefault(s => s.Id == id);
        ...
        /// <param name="entity">将要创建的一个一对多中的一</param>
        public void Create(SysEntities db, YiDuiDuoZhongDeYi entity)
        {
            if (entity != null)
            { 
                db.YiDuiDuoZhongDeYi.AddObject(entity);
            }             
        }
        /// <summary>
        /// 创建一个一对多中的一
        ...
        /// <returns></returns>
        public int Create(YiDuiDuoZhongDeYi entity)
        {
            using (SysEntities db = new SysEntities())
            {
                Create(db, entity);
        ...
        public void Create(SysEntities db, IQueryable<YiDuiDuoZhongDeYi> entitys)
        {
        ...
        /// </summary>
        /// <param name="db">实体数据</param>
        /// <param name="id">一条一对多中的一的主键</param>
        public void Delete(SysEntities db, int id)
        {
            YiDuiDuoZhongDeYi deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.YiDuiDuoZhongDeYi.DeleteObject(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<YiDuiDuoZhongDeYi> collection = from f in db.YiDuiDuoZhongDeYi
        ...
        /// </summary>
        /// <param name="db">实体数据</param>
        /// <param name="entity">将要编辑的一个一对多中的一对象</param>
        public YiDuiDuoZhongDeYi Edit(SysEntities db, YiDuiDuoZhongDeYi entity)
        {           
            db.YiDuiDuoZhongDeYi.Attach(entity);
        ...
        /// <param name="db">实体数据</param>
        /// <param name="entitys">对象集合</param>
        public void Edit(SysEntities db, IQueryable<YiDuiDuoZhongDeYi> entitys)
        {
            foreach (YiDuiDuoZhongDeYi entity in entitys)
            {
                this.Edit(db, entity);
            }
        }
