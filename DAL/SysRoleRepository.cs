...
namespace DAL
{
    ...
    public class SysRoleRepository : BaseRepository,IDisposable 
    {
        ...
        /// </summary>
        /// <returns>角色集合</returns>
        public IQueryable<SysRole> GetAll(SysEntities db)
        {
        ...
        /// <returns></returns>      
        public IQueryable<SysRole> DaoChuData(SysEntities db, FlexigridParam param, params object[] listQuery)
        {
        ...
        public void Create(SysEntities db, SysRole entity)
        {
            if (entity != null)
            { 
        ...
        public void Create(SysEntities db, IQueryable<SysRole> entitys)
        {
        ...
        /// <param name="db">实体数据</param>
        /// <param name="entitys">对象集合</param>
        public void Edit(SysEntities db, IQueryable<SysRole> entitys)
        {
