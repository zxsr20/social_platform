<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Index.Master" Inherits="System.Web.Mvc.ViewPage<DAL.SysException>" %>
...
//                            $('#divQuery').dialog("close");
            ...
            flexiOut = function (ids, grid) {
              ...
              grid.doDaoChu("../SysException/GetDaoChu");//导出数据
          };
          //导航到查看详细的按钮
            flexiView = function (ids, grid) {
                ...
                window.location.href = "../SysException/Details/" + arr[0];
                return;
                }
            }
              //导航到创建的按钮
            ...
            flexiModify = function (ids, grid) {
                ...
                if (arr.length == 1) {
                    window.location.href = "../SysException/Edit/" + arr[0];
                    return;
                }
            };
               //删除的按钮
			...
			{
			    url: '../SysException/FlexigridList',//获取数据的url
			    colModel: [
				   { display: '<%: Html.LabelFor(model => model.Id) %>', name: 'Id', width: 205, hide: true, sortable: false, align: 'left' }
					...
					, { display: '<%: Html.LabelFor(model => model.LeiXing) %>', name: 'LeiXing', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Message) %>', name: 'Message', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Result) %>', name: 'Result', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Remark) %>', name: 'Remark', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.State) %>', name: 'State', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.CreateTime) %>', name: 'CreateTime', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.CreatePerson) %>', name: 'CreatePerson', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.UpdateTime) %>', name: 'UpdateTime', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.UpdatePerson) %>', name: 'UpdatePerson', width: 107, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Version) %>', name: 'Version', hide: true, width: 107, sortable: false, align: 'left' }
