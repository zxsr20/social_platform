<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Edit.Master" Inherits="System.Web.Mvc.ViewPage<DAL.food_list>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        <legend>
            ...
            <input type="button" onclick="BackList('food_list')" value="返回列表" />
        </legend>
        <div class="bigdiv">
            ...
            <div class="editor-field"  >
                <input type="image" id="upload" name="upload"  src="/Images/tpsc.png"
                    onclick='javascript:window.open("/upload?type=3&bid=<%=Html.Encode(Model.id)%>    ");return false;'
                    />
