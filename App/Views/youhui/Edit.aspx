<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Edit.Master" Inherits="System.Web.Mvc.ViewPage<DAL.youhui>" %>
        ...
        <div class="bigdiv">
            ...
            <div class="editor-field"  >
                 ...
                 <input type="image" id="upload" name="upload"  src="/Images/tpsc.png"
                    onclick='javascript:window.open("/upload?type=4&bid=<%=Html.Encode(Model.id)%>    ");return false;'
