...
//            easyloader.theme = "gray"; // 设置主题
            using('treegrid', function () {
                $('#test').treegrid({
                    title: '部门',
//                    url: '../SysDepartment/GetAllMetadata',
                    idField: 'Id',
                    treeField: 'Name',
                    rownumbers: true,
                    toolbar: [
					...
					,{ field: 'PhoneNumber', title: '电话', width: 83 }
					,{ field: 'FaxPhoneNumber', title: '传真', width: 83 }
					,{ field: 'Address', title: '地址', width: 83 }
                    ...
                    onBeforeLoad: function (row, param) {
                        ...
                        if (row) {
                            $(this).treegrid('options').url = '../SysDepartment/GetAllMetadata/' + row.id;
                        } else {
                            $(this).treegrid('options').url = '../SysDepartment/GetAllMetadata';
                        }
                    }
                });
        ...
        function getView() {
            ...
            if (arr.length == 1) {
                ...
                window.location.href = "../SysDepartment/Details/" + arr[0];
                return;
            }
        }
        ...
        function flexiModify() {
            ...
            if (arr.length == 1) {
                ...
                window.location.href = "../SysDepartment/Edit/" + arr[0];
                return;
            }
        };
        ...
        function flexiDelete() {
            ...
            if (!confirm("确认删除这 1 项吗？"))
                return;
            $.post("../SysDepartment/Delete", { query: arr.join(",") }, function (res) {
                if (res == "OK") {
                    remove();
                    alert("删除成功!");                   
                }
