    ...
    <div id="divQuery" title="查询列表" class="easyui-dialog" closed="true" modal="false"
        style="padding: 5px; background: #fafafa;" iconCls="icon-search">
            ...
            <div class="input">
                ...
                <input type='text' id='MessageEnd_String'/>
                </div>
            </div>
            <br style="clear:both;" /> 
            <div class="input">
            ...
            <div class="input">
                ...
                <div class="editor-field">
                    <%=Html.DropDownList("StateDDL_String", App.Models.SysFieldModels.GetSysField("SysLog","State"),"请选择",new { id = "StateDDL_String" })%>
...
//                            $('#divQuery').dialog("close");
            ...
            flexiOut = function (ids, grid) {
              ...
              grid.doDaoChu("../SysLog/GetDaoChu");//导出数据
          };
          //导航到查看详细的按钮
			...
			{
			    url: '../SysLog/FlexigridList',//获取数据的url
			    colModel: [
				   { display: '<%: Html.LabelFor(model => model.Id) %>', name: 'Id', width: 205, hide: true, sortable: false, align: 'left' }
					...
					, { display: '<%: Html.LabelFor(model => model.PersonId) %>', name: 'PersonId', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Message) %>', name: 'Message', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Result) %>', name: 'Result', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.MenuId) %>', name: 'MenuId', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Ip) %>', name: 'Ip', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Remark) %>', name: 'Remark', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.State) %>', name: 'State', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.CreateTime) %>', name: 'CreateTime', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.CreatePerson) %>', name: 'CreatePerson', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.UpdateTime) %>', name: 'UpdateTime', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.UpdatePerson) %>', name: 'UpdatePerson', width: 83, sortable: true, align: 'left' }
					, { display: '<%: Html.LabelFor(model => model.Version) %>', name: 'Version', hide: true, width: 83, sortable: false, align: 'left' }
