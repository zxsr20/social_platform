    ...
    public class SysExceptionController : BaseController
    {
        ...
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，异常处理的信息的Id为" + entity.Id,"异常处理",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，异常处理的信息，" + returnValue,"异常处理", 
                        Result.Fail);//写入日志                      
        ...
        public ActionResult Edit(string id, SysException entity)
        {
            ...
            {   //数据校验
              ...
              //entity.UpdatePerson = currentPerson;
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateSucceed + "，异常处理信息的Id为" + id,"异常处理",
                        Result.Succeed);//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateFail + "，异常处理信息的Id为" + id + "," + returnValue, "异常处理", 
                        Result.Fail);//写入日志                           
