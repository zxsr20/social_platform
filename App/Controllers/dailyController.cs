    ...
    public class dailyController : BaseController
    {
        ...
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，daily的信息的Id为" + entity.id,"daily",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，daily的信息，" + returnValue,"daily", 
                        Result.Fail);//写入日志                      
        ...
        IBLL.IdailyBLL m_BLL;
        ValidationErrors validationErrors = new ValidationErrors();
        public dailyController()
            : this(new dailyBLL()) { }

        public dailyController(dailyBLL bll)
        {
            m_BLL = bll;
        }
