...
namespace App.Controllers
{
    ...
    /// 一对多中的多
    /// </summary>
    public class YiDuiDuoZhongDeDuoController : BaseController
    {
        /// <summary>
        /// Flexigrid异步加载数据
        /// </summary>
        ...
        {
            YiDuiDuoZhongDeDuo item = m_BLL.GetById(id);
            return View(item);
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Create(YiDuiDuoZhongDeDuo entity)
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，一对多中的多的信息的Id为" + entity.Id,"一对多中的多",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，一对多中的多的信息，" + returnValue,"一对多中的多", 
                        Result.Fail);//写入日志                      
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Edit(int id, YiDuiDuoZhongDeDuo entity)
        {
            if (entity != null && ModelState.IsValid)
            {   //数据校验
              ...
              //entity.UpdatePerson = currentPerson;
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateSucceed + "，一对多中的多信息的Id为" + id,"一对多中的多",
                        Result.Succeed);//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateFail + "，一对多中的多信息的Id为" + id + "," + returnValue, "一对多中的多", 
                        Result.Fail);//写入日志                           
        ...
        IBLL.IYiDuiDuoZhongDeDuoBLL m_BLL;
        ValidationErrors validationErrors = new ValidationErrors();
        public YiDuiDuoZhongDeDuoController()
            : this(new YiDuiDuoZhongDeDuoBLL()) { }

        public YiDuiDuoZhongDeDuoController(YiDuiDuoZhongDeDuoBLL bll)
        {
            m_BLL = bll;
        }
