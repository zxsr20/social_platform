    ...
    public class SysFieldController : BaseController
    {
        ...
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，数据字典的信息的Id为" + entity.Id,"数据字典",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，数据字典的信息，" + returnValue,"数据字典", 
                        Result.Fail);//写入日志                      
        ...
        public ActionResult Edit(string id, SysField entity)
        {
            ...
            {   //数据校验
              ...
              //entity.UpdatePerson = currentPerson;
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateSucceed + "，数据字典信息的Id为" + id,"数据字典",
                        Result.Succeed);//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateFail + "，数据字典信息的Id为" + id + "," + returnValue, "数据字典", 
                        Result.Fail);//写入日志                           
