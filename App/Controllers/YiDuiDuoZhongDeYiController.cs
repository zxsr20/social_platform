...
namespace App.Controllers
{
    ...
    /// 一对多中的一
    /// </summary>
    public class YiDuiDuoZhongDeYiController : BaseController
    {
        /// <summary>
        /// Flexigrid异步加载数据
        /// </summary>
        ...
        {
            YiDuiDuoZhongDeYi item = m_BLL.GetById(id);
            return View(item);
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Create(YiDuiDuoZhongDeYi entity)
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，一对多中的一的信息的Id为" + entity.Id,"一对多中的一",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，一对多中的一的信息，" + returnValue,"一对多中的一", 
                        Result.Fail);//写入日志                      
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Edit(int id, YiDuiDuoZhongDeYi entity)
        {
            if (entity != null && ModelState.IsValid)
            {   //数据校验
              ...
              //entity.UpdatePerson = currentPerson;
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateSucceed + "，一对多中的一信息的Id为" + id,"一对多中的一",
                        Result.Succeed);//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateFail + "，一对多中的一信息的Id为" + id + "," + returnValue, "一对多中的一", 
                        Result.Fail);//写入日志                           
        ...
        IBLL.IYiDuiDuoZhongDeYiBLL m_BLL;
        ValidationErrors validationErrors = new ValidationErrors();
        public YiDuiDuoZhongDeYiController()
            : this(new YiDuiDuoZhongDeYiBLL()) { }

        public YiDuiDuoZhongDeYiController(YiDuiDuoZhongDeYiBLL bll)
        {
            m_BLL = bll;
        }
