    ...
    public class SysLogController : BaseController
    {
        ...
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，日志的信息的Id为" + entity.Id,"日志",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，日志的信息，" + returnValue,"日志", 
                        Result.Fail);//写入日志                      
        ...
        public ActionResult Edit(string id, SysLog entity)
        {
            ...
            {   //数据校验
              ...
              //entity.UpdatePerson = currentPerson;
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateSucceed + "，日志信息的Id为" + id,"日志",
                        Result.Succeed);//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateFail + "，日志信息的Id为" + id + "," + returnValue, "日志", 
                        Result.Fail);//写入日志                           
