...
namespace App.Controllers
{
    ...
    /// youhui
    /// </summary>
    public class youhuiController : BaseController
    {
        /// <summary>
        /// Flexigrid异步加载数据
        /// </summary>
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Create(youhui entity)
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，youhui的信息的Id为" + entity.id,"youhui",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，youhui的信息，" + returnValue,"youhui", 
                        Result.Fail);//写入日志                      
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Edit(int id, youhui entity)
        {
            if (entity != null && ModelState.IsValid)
            {   //数据校验
              ...
              //entity.UpdatePerson = currentPerson;
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateSucceed + "，youhui信息的Id为" + id,"youhui",
                        Result.Succeed);//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateFail + "，youhui信息的Id为" + id + "," + returnValue, "youhui", 
                        Result.Fail);//写入日志                           
        ...
        IBLL.IyouhuiBLL m_BLL;
        ValidationErrors validationErrors = new ValidationErrors();
        public youhuiController()
            : this(new youhuiBLL()) { }

        public youhuiController(youhuiBLL bll)
        {
            m_BLL = bll;
        }
