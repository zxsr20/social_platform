    ...
    public class SysDepartmentController : BaseController
    {
        ...
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，部门的信息的Id为" + entity.Id,"部门",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，部门的信息，" + returnValue,"部门", 
                        Result.Fail);//写入日志                      
        ...
        public ActionResult Edit(string id, SysDepartment entity)
        {
            ...
            {   //数据校验
              ...
              //entity.UpdatePerson = currentPerson;
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateSucceed + "，部门信息的Id为" + id,"部门",
                        Result.Succeed);//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateFail + "，部门信息的Id为" + id + "," + returnValue, "部门", 
                        Result.Fail);//写入日志                           
