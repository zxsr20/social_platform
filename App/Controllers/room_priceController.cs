...
namespace App.Controllers
{
    ...
    /// room_price
    /// </summary>
    public class room_priceController : BaseController
    {
        /// <summary>
        /// Flexigrid异步加载数据
        /// </summary>
        ...
        {
            room_price item = m_BLL.GetById(id);
            return View(item);
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Create(room_price entity)
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertSucceed  + "，room_price的信息的Id为" + entity.id,"room_price",
                        Result.Succeed);//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.InsertFail + "，room_price的信息，" + returnValue,"room_price", 
                        Result.Fail);//写入日志                      
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Edit(int id, room_price entity)
        {
            if (entity != null && ModelState.IsValid)
            {   //数据校验
              ...
              //entity.UpdatePerson = currentPerson;
                ...
                {
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateSucceed + "，room_price信息的Id为" + id,"room_price",
                        Result.Succeed);//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(LogType.Operation, Suggestion.UpdateFail + "，room_price信息的Id为" + id + "," + returnValue, "room_price", 
                        Result.Fail);//写入日志                           
        ...
        IBLL.Iroom_priceBLL m_BLL;
        ValidationErrors validationErrors = new ValidationErrors();
        public room_priceController()
            : this(new room_priceBLL()) { }

        public room_priceController(room_priceBLL bll)
        {
            m_BLL = bll;
        }
