...
namespace BLL
{
    ...
    /// youhui 
    /// </summary>
    public class youhuiBLL : BaseBLL, IBLL.IyouhuiBLL
    {
        /// <summary>
        /// youhui的数据库访问对象
        /// </summary>
        youhuiRepository repository = null;
        public youhuiBLL()
        {
            repository = new youhuiRepository();
        }
        /// <summary>
        /// Flexigrid中查询的数据
        /// </summary>
        ...
        {
            int count = 0;
            IQueryable<youhui> queryData = GetByParam(id, param, ref count);
        ...
        /// <param name="id">额外的参数</param>
        /// <returns></returns>
        public youhui[] DaoChu(string id, FlexigridParam param)
        { 
        ...
        /// <returns></returns>
        public IQueryable<youhui> GetByParam(string id, FlexigridParam param, ref int count)
        {
            int page = param.Page.GetInt();
            int rp = param.RP.GetInt();

            IQueryable<youhui> queryData = repository.DaoChuData(db, param);
        ...
        /// <param name="entity">一个youhui</param>
        /// <returns></returns>
        public bool Create(ref ValidationErrors validationErrors, youhui entity)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="entitys">youhui集合</param>
        /// <returns></returns>
        public bool CreateCollection(ref ValidationErrors validationErrors, IQueryable<youhui> entitys)
        {
            try
            {
                if (entitys != null)
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="id">一youhui的主键</param>
        /// <returns></returns>  
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="deleteCollection">youhui的集合</param>
        /// <returns></returns>    
        ...
        /// <param name="entitys">youhui集合</param>
        /// <returns></returns>
        public bool EditCollection(ref ValidationErrors validationErrors, IQueryable<youhui> entitys)
        {
            try
            {
                if (entitys != null)
        ...
        /// <param name="entity">一个youhui</param>
        /// <returns></returns>
        public bool Edit(ref ValidationErrors validationErrors, youhui entity)
        {
            try
            { 
        ...
        /// 根据主键获取一个youhui
        /// </summary>
        /// <param name="id">youhui的主键</param>
        /// <returns>一个youhui</returns>
