...
namespace BLL
{
    ...
    /// 异常处理 
    /// </summary>
    public class SysExceptionBLL : BaseBLL, IBLL.ISysExceptionBLL
    {
        /// <summary>
        /// 异常处理的数据库访问对象
        /// </summary>
        ...
        {
            int count = 0;
            IQueryable<SysException> queryData = GetByParam(id, param, ref count);
        ...
        /// <returns></returns>
        public IQueryable<SysException> GetByParam(string id, FlexigridParam param, ref int count)
        {
            int page = param.Page.GetInt();
            int rp = param.RP.GetInt();

            IQueryable<SysException> queryData = repository.DaoChuData(db, param);
