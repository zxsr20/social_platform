...
namespace BLL
{
    ...
    /// shop 
    /// </summary>
    public class shopBLL : BaseBLL, IBLL.IshopBLL
    {
        /// <summary>
        /// shop的数据库访问对象
        /// </summary>
        shopRepository repository = null;
        public shopBLL()
        {
        ...
        {
            int count = 0;
            IQueryable<shop> queryData = GetByParam(id, param, ref count);
        ...
        /// <param name="id">额外的参数</param>
        /// <returns></returns>
        public shop[] DaoChu(string id, FlexigridParam param)
        { 
        ...
        /// <returns></returns>
        public IQueryable<shop> GetByParam(string id, FlexigridParam param, ref int count)
        {
            int page = param.Page.GetInt();
            int rp = param.RP.GetInt();

            IQueryable<shop> queryData = repository.DaoChuData(db, param);
        ...
        /// <param name="entity">一个shop</param>
        /// <returns></returns>
        public bool Create(ref ValidationErrors validationErrors, shop entity)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="entitys">shop集合</param>
        /// <returns></returns>
        public bool CreateCollection(ref ValidationErrors validationErrors, IQueryable<shop> entitys)
        {
            try
            {
                if (entitys != null)
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="deleteCollection">shop的集合</param>
        /// <returns></returns>    
        ...
        /// <param name="entitys">shop集合</param>
        /// <returns></returns>
        public bool EditCollection(ref ValidationErrors validationErrors, IQueryable<shop> entitys)
        {
            try
            {
                if (entitys != null)
        ...
        /// <param name="entity">一个shop</param>
        /// <returns></returns>
        public bool Edit(ref ValidationErrors validationErrors, shop entity)
        {
            try
            { 
        ...
        /// 根据主键获取一个shop
        /// </summary>
        /// <param name="id">shop的主键</param>
        /// <returns>一个shop</returns>
