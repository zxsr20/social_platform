...
namespace BLL
{
    ...
    /// food_list 
    /// </summary>
    public class food_listBLL : BaseBLL, IBLL.Ifood_listBLL
    {
        /// <summary>
        /// food_list的数据库访问对象
        /// </summary>
        food_listRepository repository = null;
        public food_listBLL()
        {
            repository = new food_listRepository();
        }
        /// <summary>
        /// Flexigrid中查询的数据
        /// </summary>
        ...
        {
            int count = 0;
            IQueryable<food_list> queryData = GetByParam(id, param, ref count);
        ...
        /// <param name="entity">一个food_list</param>
        /// <returns></returns>
        public bool Create(ref ValidationErrors validationErrors, food_list entity)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="entitys">food_list集合</param>
        /// <returns></returns>
        public bool CreateCollection(ref ValidationErrors validationErrors, IQueryable<food_list> entitys)
        {
            try
            {
                if (entitys != null)
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="id">一food_list的主键</param>
        /// <returns></returns>  
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="deleteCollection">food_list的集合</param>
        /// <returns></returns>    
        ...
        /// <param name="entitys">food_list集合</param>
        /// <returns></returns>
        public bool EditCollection(ref ValidationErrors validationErrors, IQueryable<food_list> entitys)
        {
            try
            {
                if (entitys != null)
        ...
        /// <param name="entity">一个food_list</param>
        /// <returns></returns>
        public bool Edit(ref ValidationErrors validationErrors, food_list entity)
        {
            try
            { 
        ...
        /// 根据主键获取一个food_list
        /// </summary>
        /// <param name="id">food_list的主键</param>
        /// <returns>一个food_list</returns>
