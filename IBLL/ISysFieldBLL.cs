...
namespace IBLL
{
    ...
    public interface ISysFieldBLL
    {
        ...
        /// <param name="id">额外的参数</param>
        /// <returns></returns>
        SysField[] DaoChu(string id, FlexigridParam param);
        /// <summary>
        /// 查询的数据
        /// </summary>
        /// <param name="id">额外的参数</param>
        ...
        /// <returns></returns>
        IQueryable<SysField> GetByParam(string id, FlexigridParam param, ref int count);
        /// <summary>
        /// 在查询中输入字符串，自动提示的功能
        /// </summary>
        ...
        /// <returns></returns>
        List<SysField> GetByRefParentId(string id);
