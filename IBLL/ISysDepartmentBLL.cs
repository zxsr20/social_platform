...
namespace IBLL
{
    ...
    public interface ISysDepartmentBLL
    {
        ...
        /// <param name="id">额外的参数</param>
        /// <returns></returns>
        SysDepartment[] DaoChu(string id, FlexigridParam param);
        /// <summary>
        /// 查询的数据
        /// </summary>
        /// <param name="id">额外的参数</param>
        ...
        /// <returns></returns>
        IQueryable<SysDepartment> GetByParam(string id, FlexigridParam param, ref int count);
        /// <summary>
        /// 在查询中输入字符串，自动提示的功能
        /// </summary>
        ...
        /// <returns></returns>
        List<SysDepartment> GetByRefMyParentId(string id);
