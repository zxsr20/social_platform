...
namespace IBLL
{
    ...
    public interface ISysMenuBLL
    {
        ...
        /// <param name="id">额外的参数</param>
        /// <returns></returns>
        SysMenu[] DaoChu(string id, FlexigridParam param);
        /// <summary>
        /// 查询的数据
        /// </summary>
        /// <param name="id">额外的参数</param>
        ...
        /// <returns></returns>
        IQueryable<SysMenu> GetByParam(string id, FlexigridParam param, ref int count);
        /// <summary>
        /// 在查询中输入字符串，自动提示的功能
        /// </summary>
        ...
        /// <returns></returns>
        List<SysMenu> GetByRefParentId(string id);
