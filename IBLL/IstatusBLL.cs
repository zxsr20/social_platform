...
namespace IBLL
{
    ...
    public interface IstatusBLL
    {
        ...
        /// <param name="id">额外的参数</param>
        /// <returns></returns>
        status[] DaoChu(string id, FlexigridParam param);
        /// <summary>
        /// 查询的数据
        /// </summary>
        /// <param name="id">额外的参数</param>
        ...
        /// <returns></returns>
        IQueryable<status> GetByParam(string id, FlexigridParam param, ref int count);
        /// <summary>
        /// 在查询中输入字符串，自动提示的功能
        /// </summary>
        ...
        /// <returns></returns>
        [OperationContract]
        System.Collections.Generic.List<status> GetAll();
        ...
        /// <returns></returns>
        List<status> GetByRefuserid(string id);
        ...
        /// <returns></returns>
        [OperationContract]
         bool Create(ref Common.ValidationErrors validationErrors, DAL.status entity); 
        /// <summary>
        ///  创建对象集合
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        ...
        /// <returns></returns>
        [OperationContract]
        bool CreateCollection(ref Common.ValidationErrors validationErrors, System.Linq.IQueryable<DAL.status> entitys);
        /// <summary>
        /// 删除一个对象
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        ...
        /// <returns></returns>
        [OperationContract]
        bool Edit(ref Common.ValidationErrors validationErrors, DAL.status entity); 
        /// <summary>
        ///  创建对象集合
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        ...
        /// <returns></returns>
        [OperationContract]
        bool EditCollection(ref Common.ValidationErrors validationErrors, System.Linq.IQueryable<DAL.status> entitys);
    }
}
